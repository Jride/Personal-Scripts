...
login_hook_script = home_dir + "Dropbox/Mac_Utilities/Scripts/login/loginHook.sh"
...
shell_command("launchctl unload " + launch_agent_location + file_name)
shell_command("launchctl load " + launch_agent_location + file_name)
